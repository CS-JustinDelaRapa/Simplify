...
class _QuotesPageState extends State<QuotesPage>
          ...
          Expanded(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                color: priorityTask[index].title == 'Welcome To Simplify!'
                    ? Colors.white70
                    : priorityColor[index],
                boxShadow: [
                  BoxShadow(
              ...
              child: Center(
                child: ListTile(
                  leading: priorityTask[index].title == 'Welcome To Simplify!'
                      ? null
                      : IconButton(
                          onPressed: () {
                            updateIsDone(index);
                  ...
                  title: GestureDetector(
                    ...
                    onTap: priorityTask[index].title == 'Welcome To Simplify!'
                        ? null
                        : () async {
                            await Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => AddEditTaskPage(
                                    taskContent: priorityTask[index])));
                            refreshState();
                          },
                  ),
                  subtitle: Row(
                    ...
                    children: [
                      Text(
                        DateFormat.yMMMd().format(priorityTask[index].dateSched),
                      ),
                      SizedBox(width: 10),
                    ],
                  ),
            ...
            child: Container(
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Text(
                    // 'sample quote',
                    getQuote(priorityTask[index].title, priorityTask[index].description),
  ...
  Future updateIsDone(int index) async {
    ...
    if (priorityTask[index].isSmartAlert) {
      String importantId =
          priorityTask[index].dateSched.year.toString() + priorityTask[index].id.toString();
